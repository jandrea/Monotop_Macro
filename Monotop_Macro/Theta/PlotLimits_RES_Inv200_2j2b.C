{
  ...
  Double_t y_obs_err[n]= {0.00012, 0.00008, 0.00012, 0.00030, 0.0008, 0.0022, 0.0057, 0.0152, 0.046 };
  Double_t y_obs[n]    = {0.0272,  0.0288,  0.0413,  0.0911,  0.2273, 0.551,  1.430,  4.098,  11.90 };
  Double_t y_exp2up[n] = {0.0557,  0.0671,  0.0925,  0.2013,  0.4768, 1.146,  2.917,  8.812,  22.94 };
  Double_t y_expup[n]  = {0.0346,  0.0398,  0.0553,  0.1218,  0.3008, 0.717,  1.833,  5.435,  14.54 };
  Double_t y_exp[n]    = {0.0214,  0.0249,  0.0349,  0.0773,  0.1902, 0.457,  1.190,  3.464,  9.244 };
  Double_t y_expdn[n]  = {0.0135,  0.0161,  0.0234,  0.0516,  0.1280, 0.314,  0.814,  2.342,  6.286 };
  Double_t y_exp2dn[n] = {0.0093,  0.0114,  0.0172,  0.0377,  0.0962, 0.235,  0.610,  1.716,  4.728 };

/*
  Double_t y_obs_err[n]= {0.00008, 0.00012, 0.00018, 0.00049, 0.0011, 0.0042, 0.0066, 0.0098, 0.015 };
  Double_t y_obs[n]    = {0.0203, 0.0266, 0.0380, 0.0903, 0.2263, 0.541, 1.440, 3.838 , 11.504 };
  Double_t y_exp2up[n] = {0.0584, 0.0631, 0.0844, 0.2013, 0.5138, 1.200, 3.006, 9.022 , 25.14  };
  Double_t y_expup[n]  = {0.0365, 0.0396, 0.0530, 0.1258, 0.3158, 0.727, 1.893, 5.265 , 15.19  };
  Double_t y_exp[n]    = {0.0224, 0.0249, 0.0340, 0.0779, 0.1985, 0.462, 1.198, 3.264 , 9.544  };
  Double_t y_expdn[n]  = {0.0142, 0.0163, 0.0229, 0.0527, 0.1330, 0.310, 0.809, 2.202 , 6.366  };
  Double_t y_exp2dn[n] = {0.0095, 0.0113, 0.0167, 0.0384, 0.0981, 0.233, 0.614, 1.656 , 4.718  };
*/
     /*
