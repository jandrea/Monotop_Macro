{
  ...
  if(!useATLASvsCMS){
     ...
     Double_t y_obs[n]    = {0.0332  , 0.086  , 0.145  , 0.309  , 0.539  , 0.921 , 1.225 , 1.993 , 3.55 , 5.01  };
     Double_t y_obs_err[n]= {0.0001  , 0.0004 , 0.0006 , 0.0012 , 0.0026 , 0.0039, 0.0053, 0.0077, 0.016, 0.021 };
     Double_t y_exp2up[n] = {0.546   , 1.434  , 1.404  , 2.116  , 3.07   , 4.42  , 5.680 , 7.835 , 13.6 , 20.96 };
     Double_t y_expup[n]  = {0.232   , 0.507  , 0.656  , 0.879  , 1.35   , 2.01  , 2.571 , 4.011 , 6.434, 9.68  };
     Double_t y_exp[n]    = {0.095   , 0.215  , 0.314  , 0.445  , 0.729  , 1.077 , 1.439 , 2.322 , 3.669, 5.40  };
     Double_t y_expdn[n]  = {0.0465  , 0.114  , 0.176  , 0.264  , 0.443  , 0.650 , 0.920 , 1.442 , 2.321, 3.38  };
     Double_t y_exp2dn[n] = {0.0273  , 0.0694 , 0.114  , 0.172  , 0.298  , 0.449 , 0.641 , 1.008 , 1.643, 2.325 };


/*
     //previous results with less statistics - 13 july 2015
...
*/
  ...
  c1->SaveAs("limitPlots/finalLimits_FCNC_"+name+"_"+Y_axis+"_4j2b.png");
  c1->SaveAs("limitPlots/finalLimits_FCNC_"+name+"_"+Y_axis+"_4j2b.pdf");
  c1->SaveAs("limitPlots/finalLimits_FCNC_"+name+"_"+Y_axis+"_4j2b.eps");
