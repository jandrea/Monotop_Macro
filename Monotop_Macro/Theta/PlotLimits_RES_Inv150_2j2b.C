{
  ...
  Double_t y_obs_err[n]= {0.00008, 0.00008, 0.00011, 0.00031, 0.0008, 0.0021, 0.0056, 0.0163, 0.043 };
  Double_t y_obs[n]    = {0.0211,  0.0245,  0.0409,  0.0847,  0.2323, 0.542,  1.495,  4.195,  10.92 };
  Double_t y_exp2up[n] = {0.0415,  0.0542,  0.0914,  0.1908,  0.4591, 1.138,  2.994,  9.037,  21.55 };
  Double_t y_expup[n]  = {0.0253,  0.0331,  0.0569,  0.1158,  0.2988, 0.719,  1.874,  5.604,  13.74 };
  Double_t y_exp[n]    = {0.0158,  0.0209,  0.0356,  0.0728,  0.1924, 0.458,  1.215,  3.514,  8.844 };
  Double_t y_expdn[n]  = {0.0102,  0.0135,  0.0232,  0.0482,  0.1294, 0.310,  0.825,  2.342,  6.003 };
  Double_t y_exp2dn[n] = {0.0071,  0.0097,  0.0167,  0.0357,  0.0952, 0.232,  0.619,  1.758,  4.491 };

/*
  Double_t y_obs_err[n]= {0.00008, 0.00012, 0.00018, 0.00049, 0.0011, 0.0042, 0.0066, 0.0098, 0.015 };
  Double_t y_obs[n]    = {0.0171, 0.0238, 0.0367, 0.0789, 0.2293, 0.536, 1.495, 4.055 , 11.419 };
  Double_t y_exp2up[n] = {0.0425, 0.0531, 0.0862, 0.1818, 0.5171, 1.138, 3.244, 9.037 , 26.55  };
  Double_t y_expup[n]  = {0.0263, 0.0344, 0.0529, 0.1088, 0.3178, 0.703, 1.954, 5.434 , 15.61  };
  Double_t y_exp[n]    = {0.0165, 0.0219, 0.0340, 0.0699, 0.2014, 0.445, 1.227, 3.384 , 9.724  };
  Double_t y_expdn[n]  = {0.0106, 0.0145, 0.0228, 0.0473, 0.1364, 0.303, 0.813, 2.272 , 6.513  };
  Double_t y_exp2dn[n] = {0.0071, 0.0100, 0.0164, 0.0350, 0.1016, 0.228, 0.619, 1.708 , 4.811  };
*/
     /*
