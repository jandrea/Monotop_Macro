...
void PlotLimits_RES_All_2j2b() {
  ...
  Double_t x[9]     = {500, 700, 900, 1100, 1300, 1500, 1700, 1900, 2100};

  //---------------------------------------------------------------------
  //for invariant mass of 10 GeV
  Double_t x_sec_minv10[9]    = {11.8  , 2.77  , 0.87  , 0.31  , 0.11  , 0.05 , 0.022, 0.0097, 0.0045 };
  Double_t y_obs_minv10[9]    = {0.0124, 0.0196, 0.0365, 0.0779, 0.2333, 0.557, 1.465, 3.824 , 11.005 };
  Double_t y_exp2up_minv10[9] = {0.0307, 0.0451, 0.0842, 0.1807, 0.5301, 1.239, 3.186, 8.432 , 24.07  };
  Double_t y_expup_minv10[9]  = {0.0195, 0.0283, 0.0512, 0.1118, 0.3208, 0.752, 1.923, 5.034 , 14.52  };
  Double_t y_exp_minv10[9]    = {0.0121, 0.0179, 0.0327, 0.0707, 0.2035, 0.469, 1.221, 3.144 , 8.984  };
  Double_t y_expdn_minv10[9]  = {0.0078, 0.0119, 0.0217, 0.0476, 0.1374, 0.317, 0.826, 2.122 , 6.043  };
  Double_t y_exp2dn_minv10[9] = {0.0052, 0.0086, 0.0156, 0.0354, 0.1032, 0.239, 0.619, 1.576 , 4.512  };
  ...
  Double_t x_sec_minv50[9]    = {11.8  , 2.77  , 0.87  , 0.31  , 0.11  , 0.05 , 0.022, 0.0097, 0.0045 };
  Double_t y_obs_minv50[9]    = {0.0126, 0.0206, 0.0362, 0.0772, 0.2378, 0.562, 1.464, 4.418 , 10.20  };
  Double_t y_exp2up_minv50[9] = {0.0293, 0.0473, 0.0784, 0.1729, 0.5203, 1.270, 3.300, 8.848 , 22.75  };
  Double_t y_expup_minv50[9]  = {0.0185, 0.0296, 0.0490, 0.1078, 0.3128, 0.748, 1.918, 5.494 , 13.81  };
  Double_t y_exp_minv50[9]    = {0.0117, 0.0188, 0.0319, 0.0690, 0.1955, 0.469, 1.194, 3.463 , 8.444  };
  Double_t y_expdn_minv50[9]  = {0.0076, 0.0125, 0.0213, 0.0460, 0.1313, 0.314, 0.803, 2.302 , 5.677  };
  Double_t y_exp2dn_minv50[9] = {0.0051, 0.0088, 0.0157, 0.0342, 0.0985, 0.238, 0.599, 1.728 , 4.275  };
  ...
  Double_t x_sec_minv100[9]    = {11.8  , 2.77  , 0.87  , 0.31  , 0.11  , 0.05 , 0.022, 0.0097, 0.0045 };
  Double_t y_obs_minv100[9]    = {0.0138, 0.0203, 0.0362, 0.0820, 0.3518, 0.562, 1.537, 4.080 , 11.095 };
  Double_t y_exp2up_minv100[9] = {0.0339, 0.0481, 0.0812, 0.1841, 0.7671, 1.244, 3.424, 8.832 , 23.76  };
  Double_t y_expup_minv100[9]  = {0.0216, 0.0303, 0.0510, 0.1129, 0.4738, 0.757, 2.038, 5.254 , 14.02  };
  Double_t y_exp_minv100[9]    = {0.0136, 0.0193, 0.0327, 0.0724, 0.2969, 0.478, 1.288, 3.282 , 8.878  };
  Double_t y_expdn_minv100[9]  = {0.0087, 0.0128, 0.0218, 0.0489, 0.2004, 0.323, 0.859, 2.215 , 5.963  };
  Double_t y_exp2dn_minv100[9] = {0.0059, 0.0091, 0.0159, 0.0361, 0.1491, 0.242, 0.649, 1.661 , 4.452  };
  ...
  Double_t x_sec_minv150[9]    = {11.8  , 2.77  , 0.87  , 0.31  , 0.11  , 0.05 , 0.022, 0.0097, 0.0045 };
  Double_t y_obs_minv150[9]    = {0.0171, 0.0238, 0.0367, 0.0789, 0.2293, 0.536, 1.495, 4.055 , 11.419 };
  Double_t y_exp2up_minv150[9] = {0.0425, 0.0531, 0.0862, 0.1818, 0.5171, 1.138, 3.244, 9.037 , 26.55  };
  Double_t y_expup_minv150[9]  = {0.0263, 0.0344, 0.0529, 0.1088, 0.3178, 0.703, 1.954, 5.434 , 15.61  };
  Double_t y_exp_minv150[9]    = {0.0165, 0.0219, 0.0340, 0.0699, 0.2014, 0.445, 1.227, 3.384 , 9.724  };
  Double_t y_expdn_minv150[9]  = {0.0106, 0.0145, 0.0228, 0.0473, 0.1364, 0.303, 0.813, 2.272 , 6.513  };
  Double_t y_exp2dn_minv150[9] = {0.0071, 0.0100, 0.0164, 0.0350, 0.1016, 0.228, 0.619, 1.708 , 4.811  };
  ...
  Double_t x_sec_minv200[9]    = {11.8  , 2.77  , 0.87  , 0.31  , 0.11  , 0.05 , 0.022, 0.0097, 0.0045 };
  Double_t y_obs_minv200[9]    = {0.0203, 0.0266, 0.0380, 0.0903, 0.2263, 0.541, 1.440, 3.838 , 11.504 };
  Double_t y_exp2up_minv200[9] = {0.0584, 0.0631, 0.0844, 0.2013, 0.5138, 1.200, 3.006, 9.022 , 25.14  };
  Double_t y_expup_minv200[9]  = {0.0365, 0.0396, 0.0530, 0.1258, 0.3158, 0.727, 1.893, 5.265 , 15.19  };
  Double_t y_exp_minv200[9]    = {0.0224, 0.0249, 0.0340, 0.0779, 0.1985, 0.462, 1.198, 3.264 , 9.544  };
  Double_t y_expdn_minv200[9]  = {0.0142, 0.0163, 0.0229, 0.0527, 0.1330, 0.310, 0.809, 2.202 , 6.366  };
  Double_t y_exp2dn_minv200[9] = {0.0095, 0.0113, 0.0167, 0.0384, 0.0981, 0.233, 0.614, 1.656 , 4.718  };
...
*/
  ...
  */
  ...
  TLatex* text = new TLatex(0.17, 0.92, "CMS Preliminary, L = 20 fb^{-1}, #sqrt{s} = 8 TeV, a=0.1");
