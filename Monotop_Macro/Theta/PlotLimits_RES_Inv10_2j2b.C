{
  ...
  Double_t y_obs_err[n]= {0.00005, 0.00006, 0.00011, 0.00027, 0.0009, 0.0019, 0.0048, 0.0144, 0.038 };
  Double_t y_obs[n]    = {0.0147,  0.0207,  0.0369,  0.0815,  0.2333, 0.561,  1.422,  3.854,  10.78 };
  Double_t y_exp2up[n] = {0.0293,  0.0496,  0.0789,  0.1707,  0.4831, 1.159,  2.986,  7.912,  22.47 };
  Double_t y_expup[n]  = {0.0181,  0.0294,  0.0498,  0.1078,  0.3048, 0.721,  1.853,  4.944,  13.60 };
  Double_t y_exp[n]    = {0.0114,  0.0182,  0.0320,  0.0685,  0.1945, 0.470,  1.178,  3.184,  8.724 };
  Double_t y_expdn[n]  = {0.0073,  0.0118,  0.0211,  0.0466,  0.1314, 0.318,  0.794,  2.122,  5.863 };
  Double_t y_exp2dn[n] = {0.0049,  0.0082,  0.0152,  0.0347,  0.0973, 0.237,  0.592,  1.586,  4.332 };

/*
  Double_t y_obs[n]    = {0.0124, 0.0196, 0.0365, 0.0779, 0.2333, 0.557, 1.465, 3.824 , 11.005 };
  Double_t y_obs_err[n]= {0.00008, 0.00012, 0.00018, 0.00049, 0.0011, 0.0042, 0.0066, 0.0098, 0.015 };
  Double_t y_exp2up[n] = {0.0307, 0.0451, 0.0842, 0.1807, 0.5301, 1.239, 3.186, 8.432 , 24.07  };
  Double_t y_expup[n]  = {0.0195, 0.0283, 0.0512, 0.1118, 0.3208, 0.752, 1.923, 5.034 , 14.52  };
  Double_t y_exp[n]    = {0.0121, 0.0179, 0.0327, 0.0707, 0.2035, 0.469, 1.221, 3.144 , 8.984  };
  Double_t y_expdn[n]  = {0.0078, 0.0119, 0.0217, 0.0476, 0.1374, 0.317, 0.826, 2.122 , 6.043  };
  Double_t y_exp2dn[n] = {0.0052, 0.0086, 0.0156, 0.0354, 0.1032, 0.239, 0.619, 1.576 , 4.512  };
*/
     /*
