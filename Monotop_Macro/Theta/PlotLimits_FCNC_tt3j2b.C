{
  ...
  if(!useATLASvsCMS){
     ...
     Double_t y_obs[n]    = {0.0393  , 0.092  , 0.149  , 0.296  , 0.494  , 0.851 , 1.192 , 1.950 , 3.32 , 4.46  };
     Double_t y_obs_err[n]= {0.0002  , 0.0004 , 0.0005 , 0.0011 , 0.0017 , 0.0025, 0.0044, 0.0070, 0.013, 0.017 };
     Double_t y_exp2up[n] = {0.442   , 0.882  , 1.027  , 1.445  , 2.30   , 3.33  , 4.170 , 5.945 , 11.1 , 16.56 };
     Double_t y_expup[n]  = {0.176   , 0.371  , 0.503  , 0.718  , 1.189  , 1.70  , 2.291 , 3.439 , 5.894, 8.58  };
     Double_t y_exp[n]    = {0.084   , 0.189  , 0.282  , 0.411  , 0.692  , 1.015 , 1.402 , 2.123 , 3.515, 5.14  };
     Double_t y_expdn[n]  = {0.0474  , 0.109  , 0.171  , 0.257  , 0.438  , 0.644 , 0.905 , 1.372 , 2.271, 3.30  };
     Double_t y_exp2dn[n] = {0.0297  , 0.071  , 0.113  , 0.177  , 0.301  , 0.451 , 0.638 , 0.983 , 1.617, 2.30  };
...
*/
  ...
  c1->SaveAs("limitPlots/finalLimits_FCNC_"+name+"_"+Y_axis+"_3j2b.png");
  c1->SaveAs("limitPlots/finalLimits_FCNC_"+name+"_"+Y_axis+"_3j2b.pdf");
  c1->SaveAs("limitPlots/finalLimits_FCNC_"+name+"_"+Y_axis+"_3j2b.eps");
