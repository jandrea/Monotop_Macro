...
void PlotLimits_RES_All() {
  ...
  {
    x_sec_minv10[ii]  = x_sec_minv10[ii]/4. ;
    x_sec_minv50[ii]  = x_sec_minv50[ii]/4. ;
    x_sec_minv100[ii] = x_sec_minv100[ii]/4. ;
    x_sec_minv150[ii] = x_sec_minv150[ii]/4. ;
    x_sec_minv200[ii] = x_sec_minv200[ii]/4. ;
  }
  ...
  */
  ...
  histo->GetXaxis()->SetTitle("m_{DM} (GeV)");
