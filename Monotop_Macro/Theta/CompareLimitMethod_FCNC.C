{
  ...
  Double_t x[n] = {100, 200, 300, 400, 500, 600, 700, 800, 900, 1000};
     ...
     Double_t SA_mTWonly_exp[n]       = {0.073   , 0.299  , 0.356  , 0.603  , 0.707  , 1.212 , 1.812 , 2.733 , 4.235, 5.45  };
     ...
     Double_t CC_ATLAS_exp[n]         = {0.2673,0.572,0.958,1.4180,1.931,3.65,5.744,8.68,14.07,18.69};
...
*/
  ...
  c1->SaveAs("limitPlots/new_limits_comparison_"+name+"_FCNC.png");
  c1->SaveAs("limitPlots/new_limits_comparison_"+name+"_FCNC.pdf");
  c1->SaveAs("limitPlots/new_limits_comparison_"+name+"_FCNC.eps");
